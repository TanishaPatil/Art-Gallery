...
<html lang="en">
  <head>
    ...
    <title>Alchemy Art Gallery | <?php echo $title; ?></title>
			...
			<div class="panel-heading" style="text-align:center">Log In</div>
				<div class="panel-body">
					 <form class="form-horizontal" role="form">
					  ...
					  <div class="form-group">
						<label class="control-label col-sm-12"  onclick="javascript:alert('Click on the link sent to your registered mail-id to reset password');"><a href="#">Forgot Password</a></label>
     ...
     <nav class="navbar navbar-inverse navbar-fixed-top">
		  <div class="container-fluid">
			<div class="navbar-header">
			  ...
			  <a class="navbar-brand" href="#">Alchemy Art Gallery</a>
			</div>
			<div>
				<ul class="nav navbar-nav navbar-right signup">
					...
					<li>
					 <form action="http://localhost/art/arts.php" class="navbar-form navbar-left">
